...
class DTC:
    ...
    def pretrain(self, X,
        ...
        self.autoencoder.save_weights('{}/ae_weights-epoch{}.weights.h5'.format(save_dir, epochs))
        print('Pretrained weights are saved to {}/ae_weights-epoch{}.weights.h5'.format(save_dir, epochs))
        self.pretrained = True
